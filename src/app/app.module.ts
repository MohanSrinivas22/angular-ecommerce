...
const oktaCofig = myAppConfig.oidc;
const oktaAuth = new OktaAuth(oktaCofig);

// function for members route in line: 
function sendToLoginPage(oktaAuth: OktaAuth, injector: Injector) {
  // Use injector to access service available within your application.
